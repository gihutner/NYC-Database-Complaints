                    ...
                    _createClass(TileMap, [
                        {
                            ...
                            value: function loadSrc() {
                                ...
                                var scriptPromise = new Promise(function (
                                    resolve,
                                    reject
                                ) {
                                    _this.scriptTag =
                            ...
                            value: function overlay(canvas, callback) {
                                ...
                                this.scriptTag.onload = function () {
                                    ...
                                    if (_this2.canvas.parentElement) {
                                        _this2.canvas.parentElement.appendChild(
                                            _this2.mappaDiv
                                        );
                                    } else {
                        ...
                        },
                        {
                            ...
                            value: function pixelToLatLng() {
                                return this.fromPointToLatLng.apply(
                                    this,
                                    arguments
                                );
                            },
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var Leaflet = (function (_TileMap) {
                    ...
                    function Leaflet(options) {
                        ...
                        _this.styleSrc =
                            'https://unpkg.com/leaflet@1.3.0/dist/leaflet.css';
                        _this.ready = false;
                    ...
                    _createClass(Mappa, [
                        {
                            ...
                            value: function staticMap() {
                                ...
                                if (_typeof(args[0]) === 'object') {
                                    ...
                                    var opts =
                                        _staticMap[this.provider].options()
                                            .userInput;
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function createImage() {
                                    ...
                                    Object.keys(this.options).forEach(function (
                                        option
                                    ) {
                                        if (
                                            Google.options().valid.indexOf(
                                                option
                                            ) > -1
                                        ) {
                                            _this2.imgUrl +=
                ...
                var Mapquest = (function (_StaticMap) {
                    ...
                    function Mapquest(options) {
                        ...
                        var _this = _possibleConstructorReturn(
                            ...
                            (
                                Mapquest.__proto__ ||
                                Object.getPrototypeOf(Mapquest)
                            ).call(this, options)
                        );
                            ...
                            },
                            {
                                ...
                                value: function createImage() {
                                    ...
                                    Object.keys(this.options).forEach(function (
                                        ...
                                        if (
                                            Mapquest.options().valid.indexOf(
                                                opt
                                            ) > -1
                                        ) {
                                            _this2.imgUrl +=
                                    ...
                                    google.maps.event.addListener(
                                        ...
                                        function () {
                                            ...
                                            var offsetX = -Math.round(
                                                _this2.canvas.width / pixels -
                                                    center.x
                                            );
                                            var offsetY = -Math.round(
                                                _this2.canvas.height / pixels -
                                                    center.y
                                            );
                                            var cvs =
                                                _this2.canvas.getContext(
                                                    'webgl'
                                                ) ||
                ...
                var MapboxGL = (function (_TileMap) {
                    ...
                    function MapboxGL(options) {
                        ...
                        var _this = _possibleConstructorReturn(
                            ...
                            (
                                MapboxGL.__proto__ ||
                                Object.getPrototypeOf(MapboxGL)
                            ).call(this, options)
                        );
                        ...
                        [
                            {
                                ...
                                value: function createMap() {
                                    ...
                                    this.map = new mapboxgl.Map({
                                        ...
                                        renderWorldCopies:
                                            true &&
                                            this.options.renderWorldCopies,
                                        maxBounds:
